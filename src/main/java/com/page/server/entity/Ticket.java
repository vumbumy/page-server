...
public class Ticket extends BaseContent {
    ...
    @Builder
    public Ticket(Long contentNo, String contentName, List<Permission> permissions, @NotNull Long managerNo, Boolean deleted, @NotNull Long projectNo, @NotNull Status status) {
